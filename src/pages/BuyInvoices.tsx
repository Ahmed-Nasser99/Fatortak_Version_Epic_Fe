...
import { PaginationDto, InvoiceFilterDto } from "../types/api";
...
const BuyInvoices: React.FC = () => {
  ...
  const statuses = ["Draft", "Sent", "Paid", "Pending", "Overdue", "Cancelled"];
  ...
  const handleGenerateQR = (invoiceId: string) => {
    toast.success(t("qrCodeGeneratedForInvoice"));
  };

  const handleApplyFilters = (newFilters: any) => {
    const updatedFilters = {
      ...newFilters,
      invoiceType: "Buy", // Ensure we always filter for Buy invoices
    };
  ...
  const handleConfirmDelete = async () => {
    ...
    try {
      ...
      toast.error(isRTL ? "فشل في حذف الفاتورة" : "Failed to delete invoice");
    }
  };
            ...
            <div className={`flex items-center space-x-4`}>
              ...
              <div>
                <h1 className="text-3xl font-bold mb-2">
                  {isRTL ? "فواتير الشراء" : "Purchase Invoices"}
                </h1>
                <p className="text-blue-100 text-lg">
                  {isRTL
                    ? "إدارة جميع فواتير الشراء الخاصة بك"
            ...
            {roleAccess.canCreate() && (
              ...
              >
                ...
                <span className="font-semibold">
                  {isRTL ? "إنشاء فاتورة شراء" : "Create Purchase Invoice"}
                </span>
              </Button>
            )}
          </div>
            ...
            <div className="flex flex-col xl:flex-row gap-4">
              ...
              <div className="sm:w-64">
                ...
                >
                  ...
                  <option value="PartialPaid">{t("partialpaidStatus")}</option>
                </select>
              </div>
